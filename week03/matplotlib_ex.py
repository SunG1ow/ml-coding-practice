...
plt.title('Survival Rate Variation Across Passerger Classes')
plt.xlabel('Pclass')
...
# showmean=False는 평균값을 표시하지 않도록 하고, showmedians=True는 중앙값을 표시하도록 함
...
# plt.subplot() 함수를 사용하여 하나의 그림인 figure에 개별 서브플롯을 동시에 추가
...
# 첫 번째 그래프 설정 (선 그래프)
ax1.plot(x, y1, '-s', color='indigo', markersize=7, linewidth=5, alpha=0.7, label='Nod Survived')
