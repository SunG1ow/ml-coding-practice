...
plt.title('We see more movie than TV show on Netflix.', fontfamily='serif', fontsize=12)
plt.show()
...
# 쉽표로 country 열의 값을 파이썬 리스트로 만들기
...
# wordcloud에서 작동할 수 있도록 데이터프레임을 list로 1차 변환시키고 str(문자열)로 2차 변환
